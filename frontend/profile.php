...
profile.php
-----------
Shows the dietary profile page for logged-in users.

NOTE: This page only renders the form. Profile data is loaded and saved through separate AJAX requests.
*/
...
// If session key missing, force logout
if (empty($sessionKey)) {
    session_unset();
    session_destroy();
    header("Location: login.php");
