...
```text
+-----------+----------------+---------+-----------------------------+--------+---------------------+---------------------+
| bundle_id | version_number | machine | bundle_name                 | status | created_at          | updated_at          |
+-----------+----------------+---------+-----------------------------+--------+---------------------+---------------------+
|         2 | 1.0.0          | mushran | IT490-Test-Bundle-1.0.0.zip | passed | 2026-04-22 18:44:15 | 2026-04-22 18:45:32 |
|         3 | 2.0.0          | mushran | IT490-Test-Bundle-2.0.0.zip | new    | 2026-04-22 18:54:40 | 2026-04-22 18:54:40 |
|         4 | 1.0.0          | mushran | IT490-Test-Bundle-1.0.0.zip | new    | 2026-04-22 18:55:40 | 2026-04-22 18:55:40 |
+-----------+----------------+---------+-----------------------------+--------+---------------------+---------------------+
```
